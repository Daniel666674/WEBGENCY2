  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <InfoCard title="Clientes Activos">
          ...
          <InfoCard title="Tareas y Solicitudes">
      ...
      <Callout tone="primary" title="Cambiar entre Daniel y Daniela">
        <p>
      ...
      <Callout tone="green" title="La rutina ganadora">
        <p>
