...
export const BASE_TIERS: BaseTier[] = [
  {
    ...
    features: [
      ...
      "Cumplimiento legal Colombia (Ley 1581/2012, Ley 1480/2011): páginas de privacidad, términos y aviso de cookies",
      "Banner de consentimiento de cookies — requerido para activar GA4 legalmente",
      "Google Analytics 4 + Search Console conectados",
      "SEO+GEO: robots.txt con crawlers de IA habilitados (GPTBot, ClaudeBot…), llms.txt y favicon 48 px para AI Overviews",
  ...
  },
  {
    ...
    features: [
      ...
      "Checkout por WhatsApp (Fase 1): formulario de pedido → mensaje automático a la tienda y confirmación al cliente",
  ...
  },
  {
    ...
    features: [
      ...
      "Pasarela de pago Wompi (tarjeta débito/crédito, PSE, Nequi, Bancolombia QR) — reemplaza el checkout por WhatsApp",
