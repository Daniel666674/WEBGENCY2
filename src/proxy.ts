...
export const config = {
  matcher: [
    "/((?!api/auth|api/auth-check|api/webhook|api/webhooks|api/p/|api/payments/webhook|api/payments/check-standing|api/digest|api/session-login|api/daniela-invite|api/setup/daniela|login|join|p/|demo/|_next/static|_next/image|favicon.ico|logo.png|icon-192.png|icon-512.png|apple-touch-icon.png|manifest.json|sw.js|spinner-1.png|spinner-2.png).*)",
  ],
};
